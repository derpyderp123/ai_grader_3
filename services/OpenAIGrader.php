 ...
 * OpenAI AI Grader
 * 
 * OpenAI API for code grading
 * Priority: 3 (Third attempt in fallback chain)
 */

class OpenAIGrader implements AIGrader {
...
PROMPT;
    ...
    public function getModelInfo(): string {
        return "OpenAI - {$this->model} (Cloud)";
    }
}
